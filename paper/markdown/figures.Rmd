...
```{r fig-analysis-scheme, fig.width = mm_inch(paper_figures$analysis_scheme$w), fig.height = mm_inch(paper_figures$analysis_scheme$h), dpi = 600, fig.cap = 'Study inclusion flow diagram and analysis scheme.'}

paper_figures$analysis_scheme$plot
...
```{r fig-sympt-recovery, fig.width = mm_inch(paper_figures$sympt_recovery$w), fig.height = mm_inch(paper_figures$sympt_recovery$h), dpi = 600, fig.cap = 'Kinetic of recovery from COVID-19 symptoms.'}

paper_figures$sympt_recovery$plot
...
```{r fig-pulmo-recovery, fig.width = mm_inch(paper_figures$pulmo_recovery$w), fig.height = mm_inch(paper_figures$pulmo_recovery$h), dpi = 600, fig.cap = 'Kinetic of pulmonary recovery.'}

paper_figures$pulmo_recovery$plot
...
```{r fig-model-ct, fig.width = mm_inch(paper_figures$uni_mod_ct$w), fig.height = mm_inch(paper_figures$uni_mod_ct$h), dpi = 600, fig.cap = 'Risk factors of developing persistent radiological lung abnormalities.'}

paper_figures$uni_mod_ct$plot
...
```{r fig-model-lufo, fig.width = mm_inch(paper_figures$uni_mod_lufo$w), fig.height = mm_inch(paper_figures$uni_mod_lufo$h), dpi = 600, fig.cap = 'Risk factors of developing persistent functional lung impairment.'}

paper_figures$uni_mod_lufo$plot
...
```{r fig-ft-clustering, fig.width = mm_inch(paper_figures$ft_clustering$w), fig.height = mm_inch(paper_figures$ft_clustering$h), dpi = 600, fig.cap = 'Association of incomplete symptom, lung function and radiological lung recovery with demographic and clinical parameters of acute COVID-19 and early recovery.'}

paper_figures$ft_clustering$plot
...
```{r fig-part-clustering, fig.width = mm_inch(paper_figures$som_clustering$w), fig.height = mm_inch(paper_figures$som_clustering$h), dpi = 600, fig.cap = 'Clustering of the study participants by non-lung function and non-CT clinical features.'}

paper_figures$som_clustering$plot
...
```{r fig-clust-outcome, fig.width = mm_inch(paper_figures$som_outcomes$w), fig.height = mm_inch(paper_figures$som_outcomes$h), dpi = 600, fig.cap = 'Frequency of persistent radiological lung abnormalities, functional lung impairment and symptoms in the participant clusters.'}

paper_figures$som_outcomes$plot
...
```{r fig-ml, fig.width = mm_inch(paper_figures$ml$w), fig.height = mm_inch(paper_figures$ml$h), dpi = 600, fig.cap = 'Prediction of persistent radiological lung abnormalities, functional lung impairment and symptoms by machine learning algorithms.'}

paper_figures$ml$plot
...
```{r fig-ml-severity, fig.width = mm_inch(paper_figures$ml_severity$w), fig.height = mm_inch(paper_figures$ml_severity$h), dpi = 600, fig.cap = 'Performance of the machine learning ensemble classifier in mild-to-moderate and severe-to-critical COVID-19 convalescents.'}

paper_figures$ml_severity$plot
