...
# hierarchical, kmeans, pam and dbscan clustering -----
  ...
  hcluster_data <- function(inp_tbl, distance_method = 'jaccard', k = 2, hc_method = 'ward.D2', ...) {
  ...
  kcluster_data <- function(inp_tbl, distance_method = 'jaccard', clust_fun = kmeans, k = 2, seed = NULL, ...) {
...
# plotting clustering assignment as a heat map of the distances -----
  ...
  plot_clust_mds <- function(cluster_analysis, k_dim = 2, red_fun = 'mds', 
                             ...
                             jitter_width = 0, jitter_height = 0, point_alpha = 1, legend_title = 'Cluster', ...) {
